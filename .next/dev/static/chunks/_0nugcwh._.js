...
"[project]/components/CreatePost.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(CreatePost, "3ELrUozKxfuauKZb86/1+T/kgDo=");
_c = CreatePost;
var _c;
...
function VentureCard({ post, userAccount }) {
    _s();
    const [authorHandle, setAuthorHandle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('anonymous');
    const [amount, setAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("10"); // Default to 10
    const [isInvesting, setIsInvesting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VentureCard.useEffect": ()=>{
            const getHandle = {
            ...
            }["VentureCard.useEffect.getHandle"];
            getHandle();
        }
    }["VentureCard.useEffect"], [
        post.author
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            post.imageCID && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(VentureCard, "mVB0ALRYOytvVQop8Du6SDlABYs=");
_c = VentureCard;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CreatePost$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CreatePost.tsx [app-client] (ecmascript)");
...
function Home() {
    ...
    const fetchPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[fetchPosts]": async ()=>{
            ...
            ;
            try {
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["publicClient"].readContract({
                    address: postAddr,
                    abi: [
                        {
                            name: 'getAllPosts',
...
//# sourceMappingURL=_0nugcwh._.js.map